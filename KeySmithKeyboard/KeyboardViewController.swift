...
class KeyboardViewController: UIInputViewController {
    ...
    private func setupUI() {
        ...
        passwordLabel.backgroundColor = .secondarySystemBackground
        ...
        // Generate button
        let generateBtn = makeActionButton(title: "Generate", icon: "arrow.triangle.2.circlepath", color: .systemBlue)
